class OscillatorClass {
  ...
  playNote(freq, startTime, duration) {
    ...
    this.gainNode.gain.linearRampToValueAtTime(
      max_vol,
      smooth_trans_time + ct + attack
    );
    this.gainNode.gain.linearRampToValueAtTime(
      sustainVal,
      smooth_trans_time + ct + attack + decay
    );
    this.gainNode.gain.linearRampToValueAtTime(
      sustainVal,
      smooth_trans_time + ct + attack + decay + sustain
    );
    this.gainNode.gain.linearRampToValueAtTime(
      0,
      smooth_trans_time + ct + attack + decay + sustain + release
    );
